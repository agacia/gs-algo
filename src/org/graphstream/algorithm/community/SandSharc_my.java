 ...
 * 
 */
public class SandSharc_my extends DynSharc_my {
	 ...
	 * @param marker
	 */
	public SandSharc_my(Graph graph, String marker) {
		super(graph, marker);
	}

	public SandSharc_my(Graph graph, String marker, String weightMarker) {
	 ...
	 * @param breakPeriod
	 */
	public SandSharc_my(Graph graph, String marker, int stallingThreshold,
			int breakPeriod) {
	 ...
	 * @param graph
	 */
	public SandSharc_my(Graph graph) {
		super(graph);
	}
	 ...
	 * @param breakPeriod
	 */
	public SandSharc_my(Graph graph, int stallingThreshold, int breakPeriod) {
