...
public class DynSharc_oryg extends NewSawSharc_oryg {

	protected int stallingThreshold = 5;
	protected int breakPeriod = 5;

	public DynSharc_oryg() {
		super();
	}

	public DynSharc_oryg(Graph graph, String marker) {
		super(graph, marker);
	}

	public DynSharc_oryg(Graph graph, String marker, String weightMarker) {
		super(graph, marker, weightMarker);
	}

	public DynSharc_oryg(Graph graph, String marker, int stallingThreshold,
			int breakPeriod) {
		super(graph, marker);
		setParameters(stallingThreshold, breakPeriod);
	}

	public DynSharc_oryg(Graph graph) {
		super(graph);
	}

	public DynSharc_oryg(Graph graph, int stallingThreshold, int breakPeriod) {
		super(graph);
		setParameters(stallingThreshold, breakPeriod);
	}
